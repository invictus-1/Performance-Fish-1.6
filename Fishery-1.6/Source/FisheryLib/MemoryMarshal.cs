...
// https://github.com/dotnet/runtime/blob/main/src/libraries/System.Private.CoreLib/src/System/Runtime/InteropServices/MemoryMarshal.cs
...
internal static class MemoryMarshal
{
	...
	internal static unsafe ref T GetNonNullPinnableReference<T>(ReadOnlySpan<T> span)
		=> ref span.Length != 0 ? ref Unsafe.AsRef(in span.GetPinnableReference()) : ref Unsafe.AsRef<T>((void*)1);
		...
		where TTo : struct
	{
		if (RuntimeHelpers.IsReferenceOrContainsReferences<TFrom>())
			ThrowInvalidTypeWithPointersNotSupported(typeof(TFrom));
		if (RuntimeHelpers.IsReferenceOrContainsReferences<TTo>())
			ThrowInvalidTypeWithPointersNotSupported(typeof(TTo));
