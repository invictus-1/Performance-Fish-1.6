...
public static class ReadOnlySpanExtensions
{
	...
	public static ref T DangerousGetReferenceAt<T>(this ReadOnlySpan<T> span, int i)
		...
		=> ref Unsafe.Add(ref Unsafe.AsRef(in span.GetPinnableReference()), (nint)(uint)i);
	...
	public static ref T DangerousGetReferenceAt<T>(this ReadOnlySpan<T> span, nint i)
		=> ref Unsafe.Add(ref Unsafe.AsRef(in span.GetPinnableReference()), i);
	...
	{
		ref var r0 = ref Unsafe.AsRef(in span.GetPinnableReference());
