	...
	where T1 : notnull where T2 : notnull where TResult : new()
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override int GetHashCode() => FisheryLib.HashCode.Combine(First, Second);
	...
	where T1 : notnull where T2 : notnull where T3 : notnull where TResult : new()
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override int GetHashCode() => FisheryLib.HashCode.Combine(First, Second, Third);
	...
	where TResult : new()
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override int GetHashCode() => FisheryLib.HashCode.Combine(First, Second, Third, Fourth);
