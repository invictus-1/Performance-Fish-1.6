...
public static class PrepatcherFields
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static extern PerformanceFish.Events.MapEvents.Instanced Events(this Map map);
	...
	public static PerformanceFish.Events.MapEvents.Instanced CreateMapEvents() => new();
