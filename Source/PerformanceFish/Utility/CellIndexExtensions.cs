...
public static class CellIndexExtensions
{
	...
	public static int CellToIndex(this in IntVec3 cell, CellIndices cellIndices)
		=> cell.CellToIndex(cellIndices.sizeX);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static int CellToIndex(int x, int z, CellIndices cellIndices) => CellToIndex(x, z, cellIndices.sizeX);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool IsFogged(this FogGrid fogGrid, CellIndex cellIndex) => fogGrid.fogGrid.IsSet(cellIndex.Value);
