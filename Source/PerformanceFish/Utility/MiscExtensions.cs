...
public static class MiscExtensions
{
...
#if V1_6
		return map.regionGrid.DirectGrid[c.CellToIndex(map)] is { valid: true } region
#else
	...
	public static Region? GetValidRegionAtUnchecked(this RegionGrid grid, in IntVec3 c)
	{
		...
		map.regionAndRoomUpdater.TryRebuildDirtyRegionsAndRooms();
#if V1_6
		return grid.DirectGrid[c.CellToIndex(map)] is { valid: true } region ? region : null;
#else
