...
public record struct CellIndex(int Value)
{
	...
	public CellIndex(IntVec3 cell, Map map) : this(cell, map.cellIndices.sizeX) {}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public CellIndex(IntVec3 cell, int mapSizeX) : this(cell.CellToIndex(mapSizeX)) {}

	public IntVec3 ToCell(Map map) => ToCell(map.cellIndices.sizeX);
	...
	public bool IsFogged(Map map) => map.fogGrid.fogGrid.IsSet(Value);
